...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@nuevatel.net";
    ...
    * @var string
    */
	protected $_base_dn = "DC=nuevatel,DC=net"; 
    ...
    * @var array
    */
    //protected $_domain_controllers = array ("10.40.3.97");
    protected $_domain_controllers = array ("10.40.3.97","10.20.3.97","10.30.3.97");
