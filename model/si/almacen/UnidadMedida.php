...
*/
     ...
     */
     ...
     const NONE = 0;
     // Operations
     const INSERT = "INSERT TABLE UnidadMedida";
     const UPDATE = "UPDATE TABLE UnidadMedida";
     const DELETE = "DELETE TABLE UnidadMedida";
     const SELECT = "SELECT TABLE UnidadMedida";
     ...
     * @deprecated No.
     */
        public function getList($idUnidadMedida = self::ALL){
            $result = null;
            $query = null;
            try{
                $query = " 	
     ...
     */
        public function insert($datos){
            ...
            try{
                ...
                $sentencia = $gbd->prepare("call unidad_medida_alta(?,?,?,?,?,?,?,@resultado);  ");
        ...
        public function delete($datos){
            ...
            try{
              $id=-1;                       
                ...
                $sentencia = $gbd->prepare("call unidad_medida_baja(?,?,?,?,@resultado);  ");
                $sentencia->bindParam(1, $datos[0], PDO::PARAM_STR, 4000);  
                $sentencia->bindParam(2, $datos[1], PDO::PARAM_STR, 4000); 
                $sentencia->bindParam(3, $datos[2], PDO::PARAM_STR, 4000); 
                $sentencia->bindParam(4, $datos[3], PDO::PARAM_STR, 4000); 
     ...
     */
        public function update($datos){
            ...
            try{
                ...
                $sentencia = $gbd->prepare("call unidad_medida_modif(?,?,?,?,?,?,?,@resultado); ");
                $sentencia->bindParam(1, $datos[0], PDO::PARAM_STR, 4000); 
                $sentencia->bindParam(2, $datos[1], PDO::PARAM_STR, 4000); 
                $sentencia->bindParam(3, $datos[2], PDO::PARAM_STR, 4000); 
                $sentencia->bindParam(4, $datos[3], PDO::PARAM_STR, 4000); 
