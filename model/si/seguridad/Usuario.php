        ...
        public function getList($idUsuario = self::ALL, $idEmpresa = self::ALL){
            ...
            try{
                $query = "select a.pk_id_usuario, a.usuario, a.llave, a.fk_id_persona, a.cnf_base, 
                        ...
                        b.nombres, b.apellido_paterno, b.apellido_materno, (select concat(fk_id_empresa,'_',pk_id_archivo,'.',extension) from archivo where pk_id_archivo = b.fk_id_archivo_foto and estado_registro = 'A') nombre_archivo_foto, 
