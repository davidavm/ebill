...
if ($action == 'insert') {
    try {
        if ($object->isExist(array($_POST["grupo"]))) {
            ...
            $data = array((isset($_POST["fk_id_grupo_padre"]) && ($_POST["fk_id_grupo_padre"]==NULL)?-1:$_POST["fk_id_grupo_padre"]), 
                          $_POST["grupo"], 
                          $_POST["descripcion"], 
...
if ($action == 'edit') {
    try {
        ...
        if (($object->isExist(array($_POST["grupo"]))) && ($objectEdit["grupo"] != $_POST["grupo"] )) {
            ...
            $data = array($_GET["idObject"], 
                           (isset($_POST["fk_id_grupo_padre"]) && ($_POST["fk_id_grupo_padre"]==NULL)?-1:$_POST["fk_id_grupo_padre"]),
                           $_POST["grupo"], 
                           $_POST["descripcion"], 
                           $_POST["fk_id_tipo_grupo"], 
                           $_SESSION["authenticated_id_user"], 
                    ...
                    ?>" method="post" >
                        ...
                        <div class="row col-margin">
                            <div class="form-group col-lg-6">
                                <label for="fk_id_tipo_grupo">Grupo Padre:</label>                                    
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <span  class="fa fa-bars" data-toggle="tooltip" data-placement="top" title="Opcional el valor de la lista."></span>                                        
                                    </span>
