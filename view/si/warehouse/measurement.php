...
// Prepare Object 
$object = new UnidadMedida($registry[$dbSystem]);
...
if ($action == 'insert') {
    try {
        if ($object->isExist(array($_POST["unidad_medida"]))) {
            $messageErrorTransaction = "No se puede ingresar una Unidad de Medida que ya existe. Revise los datos de UnidadMedida.";
        } else {
            $idTransaccion = $transaction->insert(array(UnidadMedida::INSERT, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));            
            $data = array($_POST["unidad_medida"],$_POST["abreviacion"], $_POST["descripcion"], $_SESSION["authenticated_id_user"], $idTransaccion, $idTransaccion, ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"]));
...
if ($action == 'delete') {
    try {
        $idTransaccion = $transaction->insert(array(UnidadMedida::DELETE, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));
...
if ($action == 'edit') {
    try {
        ...
        $objectEdit = $result[0];
        if (($object->isExist(array($_POST["unidad_medida"]))) && ($objectEdit["unidad_medida"] != $_POST["unidad_medida"])) {
            $messageErrorTransaction = "Edici&oacute;n incorrecta, se quiere ingresar una Unidad de Medida que ya existe.";
        } else {
            $idTransaccion = $transaction->insert(array(UnidadMedida::UPDATE, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));
            $data = array($_GET["idObject"], $_POST["unidad_medida"], $_POST["abreviacion"], $_POST["descripcion"], $_SESSION["authenticated_id_user"], $idTransaccion, ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"]));            
...
if ($action == 'list') {
    ...
    <div class="page-title">
        ...
        <div class="breadcrumb-env">
            <ol class="breadcrumb bc-1">
                ...
                <li class="active">
                    <strong>Manejo de unidades de medida</strong>
                </li>
            </ol>
        </div>
    </div>  
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-success">
                <div class="row">
                    <div class="col-md-3">
                        <form method="post" action="index.php?page=<?php echo $route; ?>&ci_js[0]=aditionalvalidation&cf_jscss[0]=jqvalidation&li_jq[0]=/si/warehouse/checkmeasurement&action=edit_form&action=insert_form" style="margin-top:1px;">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $indice => $register) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $register['abreviacion']; ?></td>
                                    <td><?php echo $register['descripcion']; ?></td>
                                    <td style="width: 120px;"><?php echo $register['fecha_transaccion']; ?></td>
                                    <td style="width: 80px; text-align: center">
                                        <a href="index.php?page=<?php echo $route; ?>&action=view_form&idObject=<?php echo $register['pk_id_unidad_medida']; ?>" title="<?php echo $labelOptionList["view"]; ?>" class="view_icon"><span class="glyphicon glyphicon-search"></span></a>
                                        <a href="index.php?page=<?php echo $route; ?>&ci_js[0]=aditionalvalidation&cf_jscss[0]=jqvalidation&li_jq[0]=/si/warehouse/checkmeasurement&action=edit_form&idObject=<?php echo $register['pk_id_unidad_medida']; ?>" title="<?php echo $labelOptionList["edit"]; ?>" class="edit_icon"><span class="glyphicon glyphicon-pencil"></span></a>
                                        <a href="index.php?page=<?php echo $routeFull; ?>&action=delete&idObject=<?php echo $register['pk_id_unidad_medida']; ?>" title="<?php echo $labelOptionList["delete"]; ?>" onclick="return confirmationDelete();" class="delete_icon"><span class="glyphicon glyphicon-trash"></span></a>
                                    </td>                        
                                </tr>
                                <?php
                            }
    ...
    $typeOperation = $typeOperation . " Unidad de Medida"
    ?>
        ...
        <div class="col-sm-12">
            <div class="panel panel-success">                
                <div class="panel-heading">
                    <h3 class="panel-title">Formulario para datos de Unidad de Medida</h3>                                       
                </div>
                <div class="panel-body">
                        ...
                        <div class="row col-margin">
                            <div class="form-group col-lg-6">                            
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="unidad_medida" name="unidad_medida" maxlength="255" class="form-control" type="text"<?php echo($action == 'view_form' ? 'disabled="disabled"' : NULL); ?> <?php echo($action == 'edit_form' || $action == 'view_form' ? " value=\"" . $objectEdit["unidad_medida"] . "\" " : NULL); ?>/>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">                            
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="abreviacion" name="abreviacion" maxlength="255" class="form-control" type="text"<?php echo($action == 'view_form' ? 'disabled="disabled"' : NULL); ?> <?php echo($action == 'edit_form' || $action == 'view_form' ? " value=\"" . $objectEdit["abreviacion"] . "\" " : NULL); ?>/>
                                </div>
                            </div>                            
                            <div class="form-group col-lg-6">
