...
if ($action == 'edit') {
    try {
        ...
        $objectEdit = $result[0];
        if (($object->isExist(array($_POST["almacen"]))) && ($objectEdit["almacen"] != $_POST["alamcen"] )) {
...
if ($action == 'list') {
    ...
    <div class="page-title">
        <div class="title-env">
            <h1 class="title"><i class="fa-university"></i> Almacenes</h1>
                            ...
                            foreach ($result as $indice => $register) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80px; text-align: center">
                                        <a href="index.php?page=<?php echo $route; ?>&action=view_form&idObject=<?php echo $register['pk_id_alamcen']; ?>" title="<?php echo $labelOptionList["view"]; ?>" class="view_icon"><span class="glyphicon glyphicon-search"></span></a>
                                        <a href="index.php?page=<?php echo $route; ?>&ci_js[0]=aditionalvalidation&cf_jscss[0]=jqvalidation&li_jq[0]=/si/warehouse/checkwarehouse&action=edit_form&idObject=<?php echo $register['pk_id_alamcen']; ?>" title="<?php echo $labelOptionList["edit"]; ?>" class="edit_icon"><span class="glyphicon glyphicon-pencil"></span></a>
    ...
    <div class="page-title">
        <div class="title-env">
            <h1 class="title"><i class="fa-university"></i> Almacen</h1>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="fk_id_sistema_valoracion_inventario" name="fk_id_sistema_valoracion_inventario" class="form-control" <?php echo($action == 'view_form' ? 'disabled="disabled"' : NULL); ?> >                                            
                                        ...
                                        $result = $municipio->getCatalogo('sistema_valoracion_inventario');
                                        foreach ($result as $indice => $register) {
                                        ?>
                                        <option value="<?php echo $register["fk_id_sistema_valoracion_inventario"]; ?>" <?php 
                                            if ( $objectEdit["fk_id_sistema_valoracion_inventario"] == $register["fk_id_sistema_valoracion_inventario"] )  {
                                                echo ' selected="selected" ';
                                            }
