...
// Prepare Object 
$object = new Proveedor($registry[$dbSystem]);
...
if ($action == 'insert') {
    try {
        if ($object->isExist(array($_POST["nit"], $_POST["razon_social"]))) {
            $messageErrorTransaction = "No se puede ingresar un Proveedor que ya existe. Revise los datos de Nit y Razon Social.";
        } else {
            $idTransaccion = $transaction->insert(array(Proveedor::INSERT, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));            
            $data = array($_POST["codigo"], $_POST["nit"], $_POST["razon_social"], $_POST["direccion"], $_POST["telefono1"], $_POST["telefono2"], $_POST["telefono3"], $_POST["contacto"], $_POST["fk_id_rubro"], $_POST["fk_id_departamento"],$_POST["fk_id_municipio"],$_POST["fecha1"],$_POST["fecha2"],$_POST["texto1"],$_POST["texto2"],$_SESSION["authenticated_id_user"], $idTransaccion, $idTransaccion, ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"]));
...
if ($action == 'delete') {
    try {
        $idTransaccion = $transaction->insert(array(Proveedor::DELETE, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));
...
if ($action == 'edit') {
    try {
        ...
        if (($object->isExist(array($_POST["nit"], $_POST["razon_social"]))) && ($objectEdit["nit"] != $_POST["nit"] || $objectEdit["razon_social"] != $_POST["razon_social"])) {
            $messageErrorTransaction = "Edici&oacute;n incorrecta, se quiere ingresar un Proveedor que ya existe.";
        } else {
            $idTransaccion = $transaction->insert(array(Proveedor::UPDATE, $_SESSION["authenticated_id_user"], ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"])));
            $data = array($_GET["idObject"],$_POST["codigo"], $_POST["nit"], $_POST["razon_social"], $_POST["direccion"], $_POST["telefono1"], $_POST["telefono2"], $_POST["telefono3"], $_POST["contacto"], $_POST["fk_id_rubro"], $_POST["fk_id_departamento"],$_POST["fk_id_municipio"],$_POST["fecha1"],$_POST["fecha2"],$_POST["texto1"],$_POST["texto2"],$_SESSION["authenticated_id_user"], $idTransaccion, ($_SESSION["authenticated_id_empresa"]==-1 ? NULL : $_SESSION["authenticated_id_empresa"]));
...
if ($action == 'list') {
    ...
    <div class="page-title">
        <div class="title-env">
            <h1 class="title"><i class="fa fa-fax"></i> Proveedores</h1>
            <p class="description">En esta p&aacute;gina podr&aacute; realizar operaciones relacionadas con los datos de proveedores.</p>
        </div>
        ...
        <div class="breadcrumb-env">
            <ol class="breadcrumb bc-1">
                ...
                <li class="active">
                    <strong>Manejo de proveedores</strong>
                </li>
            </ol>
        </div>
    </div>  
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-success">
                <div class="row">
                    <div class="col-md-3">
                        <form method="post" action="index.php?page=<?php echo $route; ?>&ci_js[0]=aditionalvalidation&cf_jscss[0]=jqvalidation&li_jq[0]=/si/providers/checkprovider&cf_jscss[1]=datetimepicker&action=edit_form&action=insert_form" style="margin-top:1px;">
                ...
                <div class="panel-body">                        
                    ...
                    <table id="example" class="table table-striped table-bordered table-hover table-condensed" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $result = $object->getList(Proveedor::ALL,($_SESSION["authenticated_id_empresa"]==-1?Proveedor::ALL:$_SESSION["authenticated_id_empresa"]));
                            foreach ($result as $indice => $register) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80px; text-align: center">
                                        <a href="index.php?page=<?php echo $route; ?>&action=view_form&idObject=<?php echo $register['pk_id_proveedor']; ?>" title="<?php echo $labelOptionList["view"]; ?>" class="view_icon"><span class="glyphicon glyphicon-search"></span></a>
                                        <a href="index.php?page=<?php echo $route; ?>&ci_js[0]=aditionalvalidation&cf_jscss[0]=jqvalidation&li_jq[0]=/si/providers/checkprovider&cf_jscss[1]=datetimepicker&action=edit_form&idObject=<?php echo $register['pk_id_proveedor']; ?>" title="<?php echo $labelOptionList["edit"]; ?>" class="edit_icon"><span class="glyphicon glyphicon-pencil"></span></a>
                                        <a href="index.php?page=<?php echo $routeFull; ?>&action=delete&idObject=<?php echo $register['pk_id_proveedor']; ?>" title="<?php echo $labelOptionList["delete"]; ?>" onclick="return confirmationDelete();" class="delete_icon"><span class="glyphicon glyphicon-trash"></span></a>
                                    </td>                        
                                </tr>
                                <?php
                            }
    ...
    $typeOperation = $typeOperation . " Proveedor"
    ?>
    <!-- Action insert, view or edit -->
    <div class="page-title">
        <div class="title-env">
            <h1 class="title"><i class="fa fa-fax"></i> Proveedores</h1>
            <p class="description">En este formulario usted podr&aacute; realizar <?php echo $describeTypeOperation; ?> de datos para Proveedor.</p>
        </div>
        <div class="breadcrumb-env">
            <ol class="breadcrumb bc-1">
                <li>
                ...
                <li>
                    <a href="forms-native.html">Proveedores</a>
                </li>
                <li class="active">
                    <strong>Manejo de Proveedores</strong>
                </li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-success">                
                <div class="panel-heading">
                    <h3 class="panel-title">Formulario para datos de Proveedor</h3>                                       
                </div>
                <div class="panel-body">
